...
min_dict = {time_list[0]: 2000, time_list[1]:8000, time_list[2]: 1500, time_list[3]: 20000, time_list[4]: 25000, time_list[5]:36000, time_list[6]: 42000}
# 最大步数（例如现在设置意思是在8点（你设置的第一个时间点默认8）运行会在1500到2999中随机生成一个数提交（开启气候降低步数会乘系数K）10点3000~4999。。。以此类推，步数范围建议看懂了再改，没看懂直接默认就好）
max_dict = {time_list[0]: 3999, time_list[1]: 12999, time_list[2]: 19999, time_list[3]:24999, time_list[4]: 35999, time_list[5]:39999, time_list[6]: 49999}
# 设置结束
